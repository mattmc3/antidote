...
fpath+=( $ANTIDOTE_HOME/git-AT-github.com-COLON-zsh-users-SLASH-zsh-completions.git )
source $ANTIDOTE_HOME/git-AT-github.com-COLON-zsh-users-SLASH-zsh-completions.git/zsh-completions.plugin.zsh
