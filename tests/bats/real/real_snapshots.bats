...
EOS
  assert_line "ohmyzsh: $OMZ_2024"
  assert_line "autosuggestions: $AUTOSUGGEST_2024"
}
...
echo "autosuggestions: $(git -C $ANTIDOTE_HOME/zsh-users/zsh-autosuggestions rev-parse HEAD)"
EOS
  assert_output "autosuggestions: $AUTOSUGGEST_2026"
}
...
git -C \$ANTIDOTE_HOME/ohmyzsh/ohmyzsh config antidote.pin $OMZ_2024"
  run_session <<'EOS'
echo "pinned skips: $(antidote update --bundles 2>&1 | grep -c 'skipping update for pinned bundle: ohmyzsh/ohmyzsh')"
echo "ohmyzsh: $(git -C $ANTIDOTE_HOME/ohmyzsh/ohmyzsh rev-parse HEAD)"
...
EOS
  assert_line "pinned skips: 1"
  assert_line "ohmyzsh: $OMZ_2024"
  assert_line "unpinned repos updated"
}
...
EOS
  assert_line "ohmyzsh/ohmyzsh kind:clone pin:$OMZ_2024"
  assert_line "ohmyzsh restored: $OMZ_2024"
}
